...
# =====================
# IVVB
filepath = '/Users/gustavoamarante/Library/CloudStorage/Dropbox/Personal Portfolio/data/ETFs.xlsx'
ivvb = pd.read_excel(filepath, index_col=0, na_values=['#N/A N/A'], sheet_name='values')
ivvb = ivvb['IVVB11 BZ Equity'].rename('IVVB')
ivvb = ivvb.dropna()

# BDIV
filepath = '/Users/gustavoamarante/Library/CloudStorage/Dropbox/Personal Portfolio/data/FIPs.xlsx'
...
perf = Performance(eri, skip_dd=True)
print(perf.table)
