...
for en, m in enumerate(m_values):
    ...
    ax.axhline(0.02275013, color="tab:orange", ls="--")
...
plt.tight_layout()
plt.savefig("/Users/gustavoamarante/Library/CloudStorage/Dropbox/Aulas/Doutorado - Bayesiana/HW02/part2 item4 normal.pdf")
plt.show()
